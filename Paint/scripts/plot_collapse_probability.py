...
用途：比较多个模型或温度工况的超越概率曲线，并标注相应 CMR 指标。
做法：读取易损性 Excel、设计谱、结构周期和 ``CMR.json``，完成归一化后叠加绘图。
使用：在“用户编辑区”配置结果文件映射，然后运行本文件。
"""
    ...
    for i, (model_name, path) in enumerate(file_paths.items()):
        ...
        if cmr_json_path.exists():
            try:
                ...
                print(f'⚠️ 无法读取 {cmr_json_path}: {e}')
        else:
...
if __name__ == "__main__":
    # =========================================================================
    # 用户编辑区：需要比较的曲线名称与易损性文件
    # =========================================================================
    file_paths = {
        # 'PFSDF_-20': base_dir / 'MC8_PFSDF_-20' / 'MC8_IDA_data_frag' / '易损性曲线_IDR.xlsx',
        # 'PFSDF_-10': base_dir / 'MC8_PFSDF_-10' / 'MC8_IDA_data_frag' / '易损性曲线_IDR.xlsx',
        # 'PFSDF_0': base_dir / 'MC8_PFSDF_0' / 'MC8_IDA_data_frag' / '易损性曲线_IDR.xlsx',
        # 'PFSDF_10': base_dir / 'MC8_PFSDF_10' / 'MC8_IDA_data_frag' / '易损性曲线_IDR.xlsx',
        # 'PFSDF_20': base_dir / 'MC8_PFSDF_20' / 'MC8_IDA_data_frag' / '易损性曲线_IDR.xlsx',
        # 'PFSDF_30': base_dir / 'MC8_PFSDF_30' / 'MC8_IDA_data_frag' / '易损性曲线_IDR.xlsx',
        # 'PFSDF_40': base_dir / 'MC8_PFSDF_40' / 'MC8_IDA_data_frag' / '易损性曲线_IDR.xlsx',

        'SMABF_-20': base_dir / 'MC8_SMABF_-20' / 'MC8_IDA_data_frag' / '易损性曲线_IDR.xlsx',
        'SMABF_-10': base_dir / 'MC8_SMABF_-10' / 'MC8_IDA_data_frag' / '易损性曲线_IDR.xlsx',
        'SMABF_0': base_dir / 'MC8_SMABF_0' / 'MC8_IDA_data_frag' / '易损性曲线_IDR.xlsx',
        'SMABF_10': base_dir / 'MC8_SMABF_10' / 'MC8_IDA_data_frag' / '易损性曲线_IDR.xlsx',
        'SMABF_20': base_dir / 'MC8_SMABF_20' / 'MC8_IDA_data_frag' / '易损性曲线_IDR.xlsx',
        'SMABF_30': base_dir / 'MC8_SMABF_30' / 'MC8_IDA_data_frag' / '易损性曲线_IDR.xlsx',
        'SMABF_40': base_dir / 'MC8_SMABF_40' / 'MC8_IDA_data_frag' / '易损性曲线_IDR.xlsx',
    }
    # =========================================================================
    # 用户编辑区结束
    # =========================================================================
